...
Наконец, мы можем перейти к выполнению дальнейших заданий.
...
# Индивидуальное задание - время творчества!!!

## Дабы развеятся и отдохнуть от сложных кликаний мышкой, Автор решил поставить себе задачу: сделать в терминале sql все индивидуальное задание. Вот, что у него вышло: 
...
Три **АБСОЛЮТНО** нетипичных имени: 
...
К сожалению, пункт 5 не выполним без воркбенча без дополнительных скриптов на других языках с интеграцией в модуль, рисковать- богов смешить, поэтому я дал себе поблажку:
